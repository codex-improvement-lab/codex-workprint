...
| Hosted CI | [Release commit b5ea146: four jobs passed](https://github.com/codex-improvement-lab/codex-workprint/actions/runs/33917752937), Windows/macOS × Node 22/24, including tests, release checks, JavaScript build and npm pack dry run | Exact tagged source commit; hosted runners remain distinct from physical-device acceptance |
...
| Public source / release distribution | [0.3.0-rc.3 prerelease](https://github.com/codex-improvement-lab/codex-workprint/releases/tag/v0.3.0-rc.3) published; four assets downloaded without authentication and matched local hashes; the downloaded portable ZIP built and verified a fresh receipt | GitHub distribution; no npm publication. [Machine-readable publication record](evidence/github/release-0.3.0-rc.3.json) |
