...
| Release contract | 439/439 checks passed; see the observed [preparation record](RELEASE_PREPARATION_2026-09-05.md) | No hosted CI claim |
...
| Public release / independent users / production | Not performed | Publication and market evidence remain pending |
